...
Les notions d'\emph{ensemble}\index{Ensemble} et de \emph{relation}\index{Relation} sont premières, c'est à dire qu'il n'est pas possible de les définir à partir d'autres notions.
...
\begin{figure}[ht]
  \centering
  \begin{tikzpicture}
    \draw (0,2) circle [x radius=2cm,y radius=3cm];
    \draw (-2,-1) circle [x radius=2cm,y radius=3cm,rotate=120];
    \draw (2,-1) circle [x radius=2cm,y radius=3cm,rotate=240];
    \begin{scope}
      \clip (0,2) circle [x radius=2cm,y radius=3cm];
      \clip (-2,-1) circle [x radius=2cm,y radius=3cm, rotate=120];
      \fill[pattern=dots] (2,-1) circle [x radius=2cm, y radius=3cm,rotate=240];
    \end{scope}
    \node[circle,inner sep=1pt,fill=white] at (0,5) {E};
    \node[circle,inner sep=1pt,fill=white] at (-3.4,0.4) {G};
    \node[circle,inner sep=1pt,fill=white] at (3.4,0.4) {F};
...
\begin{figure}[ht]
  \centering
  \begin{tikzpicture}
    \draw[pattern=dots] (0,2) circle [x radius=2cm,y radius=3cm];
    \draw[pattern=dots] (-2,-1) circle [x radius=2cm,y radius=3cm,rotate=120];
    \draw[pattern=dots] (2,-1) circle [x radius=2cm,y radius=3cm,rotate=240];
    \node[circle,inner sep=1pt,fill=white] at (0,5) {E};
    \node[circle,inner sep=1pt,fill=white] at (-3.4,0.4) {G};
    \node[circle,inner sep=1pt,fill=white] at (3.4,0.4) {F};
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    ...
    \node[inner sep=3pt,fill=white] at (0,0) {\(E\cap F\cap G\)};
  \end{tikzpicture}
  \caption{\label{fig:DistributiviteReunionIntersection}Distributivité de la réunion par rapport à l'interrsection.}
\end{figure}
