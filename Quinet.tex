...
Soient \(E\) et \(F\) deux ensembles. En appelle réunion de \(E\) et de \(F\) l'ensemble, noté \(E\cup F\), constitué des éléments appartenant à l'un au moins des ensembles \(E\) et \(F\) (Fig. \ref{fig:réunion}). Le symbole \(\cup\) se lit «~union~».
